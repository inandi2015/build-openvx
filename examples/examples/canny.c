...
int main(int argc, char *argv[])
{
  ...
  if (context)
  {
    ...
    vxSetThresholdAttribute(hyst, VX_THRESHOLD_ATTRIBUTE_THRESHOLD_LOWER, &lo, sizeof(lo));
    vxSetThresholdAttribute(hyst, VX_THRESHOLD_ATTRIBUTE_THRESHOLD_UPPER, &hi, sizeof(hi));
    vx_int32 winsz = 3;
