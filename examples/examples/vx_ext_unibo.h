...
enum vx_kernel_retina_ext_e {
    VX_KERNEL_UNIBO_COMPLEMENTARY      = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0x0,
    VX_KERNEL_UNIBO_NORMALIZE          = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0x1,
    VX_KERNEL_UNIBO_GAUSSIAN5X5        = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0x2,
    VX_KERNEL_UNIBO_THRESHOLD_TO_ZERO  = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0x3,
    VX_KERNEL_UNIBO_TRUNCATE           = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0x4,
    VX_KERNEL_UNIBO_ADD_SCALAR         = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0x5,
    VX_KERNEL_UNIBO_DIVIDE             = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0x6,
    VX_KERNEL_UNIBO_SIGMOID            = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0x7,
    VX_KERNEL_UNIBO_MEAN               = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0x8,
    VX_KERNEL_UNIBO_STDDEV             = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0x9,
    VX_KERNEL_UNIBO_MAX3x3             = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0xA,
    VX_KERNEL_UNIBO_MAX7x7             = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0xB,
    VX_KERNEL_UNIBO_NONMAX             = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0xC,
    VX_KERNEL_UNIBO_FAST9              = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0xD,
    VX_KERNEL_UNIBO_INTEGRALWINDOW     = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0xE,
    VX_KERNEL_UNIBO_DISPARITY          = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_RETINA) + 0xF,
};
//! [KERNEL ENUM]
 ...
 * \param [out] output The output image.
 */
vx_node vxNormalizeNode(vx_graph graph, vx_image input, vx_scalar min, vx_scalar max, vx_image output);
 ...
 * \param [out] output The output image.
 */
vx_status vxuNormalize(vx_image input, vx_scalar min, vx_scalar max, vx_image output);
 ...
 * \param [out] output The output image.
 */
vx_node vxGaussian5x5Node(vx_graph graph, vx_image input, vx_scalar sigma, vx_image output);
 ...
 * \param [out] output The output image.
 */
vx_node vxThresholdToZeroNode(vx_graph graph, vx_image input, vx_scalar th, vx_image output);
 ...
 * \param [out] output The output image.
 */
vx_node vxTruncateNode(vx_graph graph, vx_image input, vx_scalar th, vx_image output);
 ...
 * \param [out] output The output image.
 */
vx_node vxAddScalarNode(vx_graph graph, vx_image input, vx_scalar value, vx_scalar scale, vx_image output);
 ...
 * \param [out] output The output image.
 */
vx_status vxuAddScalar(vx_image input, vx_scalar value, vx_scalar scale, vx_image output);
 ...
 * \param [out] output The output image.
 */
vx_node vxDivideNode(vx_graph graph, vx_image input1, vx_image input2, vx_image output);
 ...
 * \param [out] output The output image.
 */
vx_node vxSigmoidNode(vx_graph graph, vx_image input, vx_scalar mean, vx_scalar std, vx_scalar slope, vx_scalar minRange, vx_scalar maxRange, vx_image output);
 ...
 * \param [out] output The output image.
 */
vx_status vxuSigmoid(vx_image input, vx_scalar mean, vx_scalar std, vx_scalar slope, vx_scalar minRange, vx_scalar maxRange, vx_image output);
 ...
 */
vx_node vxStdDevNode(vx_graph graph, vx_image input, vx_scalar mean, vx_scalar std);
 ...
 * \param [out] output The output image.
 */
vx_node vxNonMaxSuppression2Node(vx_graph graph, vx_image input, vx_image max, vx_image output);

/*! \brief [Immediate] Immediate mode version of the non-maxima suppressione node.
 * \param [in] input The input image.
 * \param [in] max The image with max values
 * \param [out] output The output image.
 */
 ...
 * \param [out] output The output image.
 */
vx_node vxFAST9Node(vx_graph graph, vx_image input, vx_scalar th, vx_image output);
 ...
 * \param [out] output The output image.
 */
vx_node vxIntegralWindowNode(vx_graph graph, vx_image input, vx_scalar windowSize, vx_image output);
 ...
 * \param [out] output The output image.
 */
vx_status vxuIntegralWindow(vx_image input, vx_scalar windowSize, vx_image output);
 ...
 */
vx_node vxDisparityNode(vx_graph graph, vx_image input, vx_image minVals, vx_image current, vx_scalar level, vx_image minOut, vx_image output);
 ...
 * \param [out] output The output image (disparity level).
 */
vx_status vxuDisparity(vx_image input, vx_image minVals, vx_image current, vx_scalar level, vx_image minOut, vx_image output);
